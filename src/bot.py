	...
	def run(self):
		...
		while True:
			...
			if irc.check_for_message(data):
				...
				'''
				@Chuby1Tubby - Bet complete for RED, 25000. Your new balance is 81880.
				'''
				if (username != 'chuby1tubby'):
					if (username == 'xxsaltbotxx'):
						if ('Bet complete for' in message and 'you_are_being_shellfish' in message):
							...
							# Use shellfish's bet amount
							# amt = int(amt / 3)

							# Reverse shellfish's bet
							# if (team == 'red'):
							# 	team = 'blue'
							# else:
							# 	team = 'red'
